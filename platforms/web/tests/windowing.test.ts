...
import {
  SceneClient,
  type CanvasSummary
} from "../runtime/sceneClient";
import {
  WsTransport,
  backoffDelay,
  type ReconnectOptions,
  type WebSocketLike
} from "../runtime/wsTransport";
import { InMemoryOutboxStore } from "../runtime/outbox";
import { ensureSceneCore } from "../bridge/sceneCoreWasm";
import type { Bbox, ClientMessage, ServerMessage, WelcomeMessage } from "../runtime/transport";
import {
  emptyObjectScene,
  translateTransform,
