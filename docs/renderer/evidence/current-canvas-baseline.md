...
- Historical `tests/app.spec.ts`: old end-to-end coverage for group creation, tag attach/filter, node edit, comments, copy/paste, z-order, export. The replacement branch removes this Playwright-based test path.
